...
export default function PrivacyPolicy() {
    ...
    return (
        <Container maxW={'xxl'} p={[2,5,10]} backgroundColor={color}  px={[5,5,10,20]} color='#837d71'  fontFamily={`'Rubik', sans-serif`}>
            ...
            <Text>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator/" >Free Privacy Policy Generator</a>.</Text>
            <Heading pb={5}>Interpretation and Definitions</Heading>
            ...
            <UnorderedList>
                ...
                <ListItem>
                    <Text><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Trading school , hshshs.</Text>
                </ListItem>
                <ListItem>
                ...
                <ListItem>
                    <Text><strong>Country</strong> refers to: Haryana,  India</Text>
                </ListItem>
                <ListItem>
                ...
                <ListItem>
                    <Text><strong>Personal Data</strong> is any information that relates to an identified or identifiable inContaineridual.</Text>
                </ListItem>
                <ListItem>
                    <Text><strong>Service</strong> refers to the Website.</Text>
                </ListItem>
                <ListItem>
                    <Text><strong>Service Provider</strong> means any natural or legal person who processes the data on behalf of the Company. It refers to third-party companies or inContaineriduals employed by the Company to facilitate the Service, to provide the Service on behalf of the Company, to perform services related to the Service or to assist the Company in analyzing how the Service is used.</Text>
                </ListItem>
                <ListItem>
                ...
                <ListItem>
                    <Text><strong>Website</strong> refers to Trading school , accessible from <a href="https://tradingschool.netlify.app/" rel="external nofollow noopener" >https://tradingschool.netlify.app/</a></Text>
                </ListItem>
                <ListItem>
                    <Text><strong>You</strong> means the inContaineridual accessing or using the Service, or the company, or other legal entity on behalf of which such inContaineridual is accessing or using the Service, as applicable.</Text>
                </ListItem>
            </UnorderedList>
            <Heading pb={5}>Collecting and Using Your Personal Data</Heading>
            ...
            <Text>Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies on the <a href="https://www.freeprivacypolicy.com/blog/sample-privacy-policy-template/#Use_Of_Cookies_And_Tracking" >Free Privacy Policy website</a> article.</Text>
            ...
            <UnorderedList>
                ...
                <ListItem>
                    <Text><strong>For business transfers:</strong> We may use Your information to evaluate or conduct a merger, Containerestiture, restructuring, reorganization, dissolution, or other sale or transfer of some or all of Our assets, whether as a going concern or as part of bankruptcy, liquidation, or similar proceeding, in which Personal Data held by Us about our Service users is among the assets transferred.</Text>
                </ListItem>
                <ListItem>
            ...
            <Heading pb={5}>Children's Privacy</Heading>
            ...
            <Heading pb={5}>Links to Other Websites</Heading>
            ...
            <Heading pb={5}>Changes to this Privacy Policy</Heading>
            ...
            <Heading pb={5}>Contact Us</Heading>
            <Text>If you have any questions about this Privacy Policy, You can contact us:</Text>
            <UnorderedList>
                <ListItem>
                    <Text>By email: https://tradingschool.netlify.app/</Text>
                </ListItem>
                <ListItem>
                    <Text>By visiting this page on our website: <a href="https://tradingschool.netlify.app/" rel="external nofollow noopener" >https://tradingschool.netlify.app/</a></Text>
                </ListItem>
                <ListItem>
                    <Text>By phone number: hahhah</Text>
                </ListItem>
            </UnorderedList>
        </Container>
    )
